...
_OPS_SHEETS: frozenset[str] = frozenset({
    ...
    # Franchise Pending Orders page snapshot (CRM pending orders + MIS presence)
    "Franchise pending orders",
})
...
_OPS_PREFIXES: tuple[str, ...] = (
    ...
    "Monthly Godrej Booking ",  # Order-Booked report state ("Monthly Godrej Booking <Month>")
)
