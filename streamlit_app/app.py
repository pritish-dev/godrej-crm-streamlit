...
sales_handbook_pages = [
    ...
    st.Page("pages/28_Franchise_Pending_Orders.py",    title="Franchise Pending Orders",            icon="📥"),
    st.Page("pages/55_Monthend_Sales_Forecast.py",    title="Monthly Sales Target vs Achievement", icon="📅"),
    st.Page("pages/45_Monthly_Godrej_Booking.py",      title="Monthly Godrej Booking",              icon="📒"),
...
inventory_pages = [
    ...
    st.Page("pages/61_Discontinued_Products.py", title="Discontinued Products", icon="🚫"),
]
